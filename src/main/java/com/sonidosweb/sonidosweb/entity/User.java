package com.sonidosweb.sonidosweb.entity;
...
public class User {
    ...
    @Column(name = "has_android_license")
    private boolean hasAndroidLicense = false;

    @Column(name = "has_desktop_license")
    private boolean hasDesktopLicense = false;
